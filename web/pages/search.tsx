...
import LocationSearch from "../modules/SearchLocation/SearchLocation";
...
const Search = () => {
  ...
  return (
    <Box className={classes.relative}>
      {openSearch ? (
        <LocationSearch onBackClick={() => setOpenSearch(false)} />
      ) : (
        <>
          <HomeLayout>
            <Header />
            <SearchLocation onClick={() => setOpenSearch(true)} />
            <Map />
